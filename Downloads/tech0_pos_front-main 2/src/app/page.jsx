...
//             },
//             (decodedText) => {
//               setBarcode(decodedText); // バーコードをセットするが、ここではまだ商品を問い合わせない
//               console.log(`バーコードを読み取りました: ${decodedText}`);
//             },
//             (errorMessage) => {
...
//                 barcode ? "" : "opacity-50 cursor-not-allowed"
//               }`}
//               disabled={!barcode}
//             >
//               読み取り
...
//               <p>この商品を購入しました。</p>
//               <p>合計金額（税込）: ¥{totalAmount}</p>
//               <p>合計金額（税抜）: ¥{totalAmountExclTax.toFixed(2)}</p>
//               <button
//                 onClick={clearCart}
//                 className="bg-blue-500 text-white py-2 px-4 mt-4 rounded shadow-lg hover:bg-blue-600 transition duration-300"
//               >
//                 確認
//               </button>
//             </div>
